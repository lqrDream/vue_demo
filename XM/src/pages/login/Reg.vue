<template>
  <div class="content">
    ...
    <ul>
      ...
      <li>
        <input type="text" v-model="password" value="" @keyup.enter="dlHandle"/>
        <span>密码</span>
      </li>
    </ul>
    <div class="footbox">
      <input type="button" value="注 册" class="login-btn" @click="dlHandle"/>
...
<style scoped>
  .content{max-width:6.4rem; margin:0 auto;min-height: 9.4rem}
  .content .fhbtn{ padding-top:0.27rem;}
  .content .fhbtn a{ margin-left:0.3rem; font-size: 28px;}
  .content h1{width:2.18rem;height:1.35rem; background:url(../../assets/img/1.jpg) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
