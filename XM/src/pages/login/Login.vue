<template>
  <div class="content">
    <p class="fhbtn"><a href="javascript:;" @click="$router.go(-1)"><</a></p>
    <h1></h1>
    <div class="login-box">
      <p class="lsolid"></p>
      <div class="login">
    ...
    <ul>
      ...
      <li>
        <input type="text" :value="password" @input="password=$event.target.value" @keyup.enter="dlHandle"/>
        <span>密码</span>
      </li>
      {{msg}}
    </ul>
    <div class="footbox">
      <input type="button" value="登 录" class="login-btn" @click="dlHandle"/>
